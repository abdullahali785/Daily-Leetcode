...
class Solution:
    ...
    def topKFrequent_bucket2(self, nums: list[int], k: int) -> list[int]:    
        count = {}
    ...
    def productExceptSelf_lowMemory(self, nums: list[int]) -> list[int]:
        res = [1] * len(nums)
        pre, post = 1, 1
    ...
    def checkInclusion_long(self, s1: str, s2: str) -> bool:
        if len(s1) > len(s2):
            return False
